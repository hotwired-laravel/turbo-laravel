<div id="@domid($article, 'card')" class="p-4 relative rounded hover:bg-gray-50 focus-within:bg-gray-50 focus-within:ring focus-within:ring-indigo-500 focus-within:ring-inset transition transform">
